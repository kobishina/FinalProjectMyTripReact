    ...
    return (
        ...
        <div onSubmit={onSubmit} className="container-fluid bg_home p-0">
            <div className="text-center bg-info">
                <h1 className="fs-1 fst-italic m-0 pt-3 py-2 h1Fount">wellcome to your trip today </h1>
            </div>
            <MyCarousel />
                    ...
                    <div className='col-md-4 col-12 mt-3  '>
                        <div data-aos="fade-down">
                            <div className='p-2 border border-1 rounded box'>
                                ...
                                <div >
                                    <img className='w-100' src={america} alt='america' />
                                </div>
                    ...
                    <div className='col-md-4 col-12 mt-3  '>
                        <div data-aos="fade-down">
                            <div className='p-2 border border-1 rounded box'>
                                ...
                                <div >
                                    <img className='w-100' src={asia} alt='asia' />
                                </div>
                                <p>Asia entices travelers with its remarkable diversity, from the bustling streets of Tokyo and Shanghai to the serene landscapes of Bali and the Himalayas. Discover ancient wonders like the Great Wall of China and Angkor Wat, or indulge in the vibrant street food scenes of Bangkok and Seoul. Immerse yourself in rich cultures, from the colorful festivals of India to the tranquil gardens of Japan, ensuring an unforgettable journey through this captivating continent.</p>
                            </div>
                        </div>
                    </div>
                    {/* box */}
                    ...
                    <div className='col-md-4  col-12 mt-3 '>
                        <div data-aos="fade-down-right">
                            <div className='p-2 border border-1 rounded box'>
                                ...
                                <div >
                                    <img className='w-100' src={israel} alt='israel' />
                                </div>
                                <p>Israel, a land of contrasts, offers travelers a rich tapestry of history, culture, and natural beauty. Explore ancient sites like Jerusalem's Old City, the Dead Sea, and the fortress of Masada. Indulge in vibrant cuisine, from traditional hummus and falafel to modern fusion dishes. Experience the vibrant energy of Tel Aviv's beaches and nightlife scene. Discover the diverse landscapes, from the lush Galilee region to the desert landscapes of the Negev. With its captivating mix of old and new.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='col-md-4  col-12 mt-3 '>
                        <div data-aos="fade-down">
                            <div className='p-2 border border-1 rounded box'>
                                ...
                                <div >
                                    <img className='w-100' src={vietnam} alt='vietnam' />
                                </div>
                                <p>Vietnam enchants travelers with its stunning landscapes, rich culture, and delicious cuisine. Explore the bustling streets of Hanoi's Old Quarter and the vibrant markets of Ho Chi Minh City. Cruise through the iconic limestone karsts of Halong Bay or trek through the terraced rice fields of Sapa. Delve into the country's complex history at sites like the Cu Chi Tunnels and the Imperial City of Hue. With its warm hospitality and diverse offerings, Vietnam promises for every traveler rice paddies of the Mekong Delta, Vietnam offers a diverse range of experiences for travelers.</p>
                            </div>
                        </div>
                    </div>
                </div>
